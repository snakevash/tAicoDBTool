...
<div id="header">
    <h1><a href="/dashboard.html">艾果智能数据管理系统</a></h1>
</div>
...
<div id="sidebar">
    ...
    <ul>
        ...
        <li class="submenu">
            ...
            <ul>
                <li><a href="form-common.html">品牌上传/更新</a></li>
                <li><a href="form-validation.html">遥控器上传/更新</a></li>
                <li><a href="form-wizard.html">系列上传/更新</a></li>
            </ul>
        </li>
    </ul>
</div>
...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Site
                    Statistics</h5>
...
<div class="row-fluid">
    <div class="span6">
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-file"></i></span><h5>Recent Posts</h5>
                <span title="54 total posts" class="label label-info tip-left">54</span></div>
    ...
    <div class="span6">
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-comment"></i></span><h5>Recent
                    Comments</h5><span title="88 total comments" class="label label-info tip-left">88</span></div>
            <div class="widget-content nopadding">
...
<div class="row-fluid">
    <div class="span12">
        <div class="widget-box widget-calendar">
            <div class="widget-title"><span class="icon"><i class="icon-calendar"></i></span><h5>Calendar</h5>
            </div>
            <div class="widget-content nopadding">
